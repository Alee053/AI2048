...
Examples:
    ...
    python scripts/evaluate.py data/archive/v3-100m/models/release/Hybrid-PPO-Expectimax-v3.zip --depth 3

    # Raw policy (no search)
    python scripts/evaluate.py data/archive/v3-100m/models/release/Hybrid-PPO-Expectimax-v3.zip --no-search
"""
